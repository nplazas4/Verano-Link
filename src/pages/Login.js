...
const divInput = (
    <div className="my-3">
        <Input type="text" class="validate inputTop" placeholder="Correo Electrónico"/>
        <div className="relative cont-input-pass">
            <Input id="input-pass" type="password" class="validate inputBottom" placeholder="Contraseña"/>
            <div onClick={changeView} id="off-eye" className="cont-icon" style={inputStyle}>
...
const divBtn = (
    <div className="input-field">
        ...
        <div className="tc mt-2">
            <a className="waves-effect waves-black btn-flat modal-trigger t-semibold" href="#modalForgotPassword">
...
const modalLogin = (
    <div id="modalForgotPassword" className="modal s12">
        ...
        <div className="modal-footer tc">
            <a href="#!" className=" modal-action modal-close btn waves-effect waves-light t-semibold">
                Recuperar contraseña
            </a>
        </div>
    </div>
