                            ...
                            <div className="row">
                                ...
                                <div className="col xl9 l6 m12 s12">
                                    <div className="graph-card" style={{minHeight: 400+'px'}}>
                                        ...
                                        <div id="chartdiv" style={{width: 100+'%', height: 270+'px'}}></div>
                                    </div>
                                </div>
                                <div className="col xl3 l6 m6 s12">
                                    <div className="graph-card" style={{minHeight: 400+'px'}}>
                                        ...
                                        <div id="chartDonut" style={{width: 90+'%', height: 370+'px', marginLeft: 5+'%'}}></div>
                                    </div>
                                </div>
                                <div className="col l6 m6 s12">
                                    <div className="graph-card">
                                        ...
                                        <div id="chartdiv2" style={{width: 100+'%', height: 270+'px'}}></div>
                                    </div>
                                </div>
                                <div className="col l6 m12 s12">
                                    <div className="graph-card">
                                        ...
                                        <div id="chartdiv3" style={{width: 100+'%', height: 270+'px'}}></div>
                                    </div>
                                </div>
                            </div>
                        </div>
